...
<header class="header left">
  <div class="left nav">
      <ul>
          ...
          <li class="nav_active"><i class="nav_4"></i><a href="#">话务大数据</a> </li>
    ...
    <div class="div_any">
        <div class="div_any_child" style="width:98%;position:relative;height: 420px;">
            ...
            <div id="PbxPage"  style="width: 100%;display: inline-block;height: 400px;margin-top: 15px;">
                <iframe id="frame" width="98%" height="100%" allowTransparency="true" frameborder="no" style="margin: 1%" scrolling="no" src="http://124.227.230.82:8888/extenmonitor.jsp"></iframe>
            </div>
        </div>
