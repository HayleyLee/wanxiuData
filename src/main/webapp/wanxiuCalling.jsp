...
<div class="con left">
        ...
        <div class="con_div_text left">
            <div class="con_div_text01 left">
                ...
                <div class="left text01_div">
                    <p>线上服务总量</p>
                    <div class="js-odoo" id="allCall" style="fill: #ffff43;"></div>
                </div>
            </div>
            <div class="con_div_text01 right">
                ...
                <div class="left text01_div">
                    <p>线上呼出量</p>
                    <div class="js-odoo" id="OutCall" style="fill: #ffff43;"></div>
                </div>
            </div>
        </div>
        <div class="con_div_text left">
            <div class="con_div_text01 left">
                ...
                <div class="left text01_div">
                    <p>线上呼入量</p>
                    <div class="js-odoo" id="InCall" style="fill: #25f3e6;"></div>
                </div>
            </div>
            <div class="con_div_text01 right">
                <img src="static/images/img/info_3.png" class="left text01_img"/>
                <div class="left text01_div">
                    <p>今日呼出量</p>
                    <div class="js-odoo" id="OutCallToDay" style="fill: #25f3e6;"></div>
                </div>
            </div>
        </div>
        <div class="con_div_text left">
            ...
            <div class="con_div_text01 left">
                ...
                <div class="left text01_div">
                    <p>今日呼入量</p>
                    <div class="js-odoo" id="InCallToDay" style="fill: #ff4e4e;"></div>
                </div>
            </div>
            <div class="con_div_text01 right">
                ...
                <div class="left text01_div">
                    <p>同比昨日趋势</p>
                    <div class="js-odoo" id="Percentage" style="fill: #ff4e4e;"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="con left" style="width:50%;">
        ...
        <div class="div_any">
            ...
            <div class="div_any_child" style="width:98%;position:relative;height: 420px;">
                <div class="div_any_title"><img src="static/images/img/title_13.png">每周话务坐席通话统计</div>
                <div id="PbxWeek"  style="width: 100%;display: inline-block;height: 400px;margin-top: 15px;padding: 5%">
